...
public class ChiSquareUtils {
     ...
     * x valor tipo doble
     * df Grados de Libertad tipo entero
     * http://www.vvlasov.com/2013/06/how-to-calculate-pvalue-from-chisquare.html
     */
   ...
   /**
    * Probabilidad de Z P-Value = valor de confiabilidad del proceso
    */
    ...
    public static void main(String[] args) {
        System.out.println(pochisq(0.028497025, 1));
