 ...
 * @author Loena
 */
public class ProcesarSNPRestoIndividuosCopia extends Thread
{
    int casohombre;
    int casomujer;
    int controlhombre;
    ...
    public  ProcesarSNPRestoIndividuosCopia(int casohombre, int casomujer, int controlhombre, int controlmujer, int total, int j, String[] fileDetail, ArrayList<SNP> snpArray) {
